    ...
    <div >
        <el-tabs v-model="activeName"  @tab-click="handleClick" type="border-card">
            ...
            <el-tab-pane label="试卷题目" name="second" disabled>
                <!-- 右侧固定menu -->
                <el-menu class="el-menu-demo el-menu-fixed" mode="vertical" @select="handleSelectFixed" v-if="this.activeName =='second' ">
...
<style scoped>
    ...
    .el-menu-fixed{width:120px;position: fixed;top: 180px;right: 20px;text-align:center;z-index:8}
    ...
    methods: {
        ...
        goToThird(formName) { 
	        ...
	        if(!pass){
                ...
                // console.log(this.paper.sinSelection)
                // console.log(this.paper.mulSelection)
                // console.log(this.paper.judgement)
                // console.log(this.paper.blankFill)
                // console.log(this.paper.shorDiscuss)
                ...
                if (valid) {
                    ...
                    .then(function(res){
                        ...
                        if (res.data.code == 200) {
                            that.$message.success({message: '创建试卷成功！'})
                            that.$router.push({path: '/examList'})
                        } else {
                            that.$message.error('创建试卷失败！')
                            return
                        }
                    }).catch(function (res) {
                        console.log(res)
