            ...
            <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <!-- <el-button type="primary" size="mini" @click="setopen(scope.row,1)" v-if="scope.row.status==0">启动</el-button> -->
            ...
            <div class="popUpcontent">
                ...
                <div class="contentbox">
                    ...
                    <ul class="content">
                        ...
                        <li>
                            <label>报名地址:</label><span>{{detail.enrolAddress}}</span>
                        </li>
                        <li>
              ...
              if(res.data.code==200){         
                ...
                //   that.pageSize=res.data.fsp.pageSize
                  ...
                  that.tableData.forEach(function(v,i){                   
                    ...
                    that.tableData[i].enrolTime=that.getTimer(new Date(that.tableData[i].enrolStartDate))+'至'+that.getTimer(new Date(that.tableData[i].enrolEndDate))
                    that.tableData[i].trainTime=that.getTimer(new Date(that.tableData[i].trainStartDate))+'至'+that.getTimer(new Date(that.tableData[i].trainEndDate))
                    if(v.status==1){
                        v.status1='已发布'
                    }else if(v.status==0){
                        v.status1='未发布'
