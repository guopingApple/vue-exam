        ...
        creatPaper(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    let obj = Object.assign(this.formInfo, this.questionArr, this.paperSet);
                    console.log(obj)

                    // this.axios.post('http://192.168.1.32:8080/paper/page',obj,{headers: {'Content-Type': 'application/x-www-form-urlencoded'}})
