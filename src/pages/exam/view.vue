    ...
    <div class="p15">
        <el-tabs type="border-card">
                ...
                <div class="viewExam">
                    ...
                    <div v-for="(item,index) in questionList">
                        ...
                        <dl v-if="item.questionType == 3">
                            <dt>{{ index + 1 }}.{{item.question}}<span class="pl15">(判断题)</span> {{ item.score }}分</dt>
                            <dd>
                                A. 对   B.错
                            </dd>
                        </dl>
            ...
            <el-tab-pane label="试卷设置">
                <el-form :model="paperSet" class="pt20" label-width="100px" style="width:600px">
                    <el-form-item label="答题时段">
                        <el-col :span="10">
                            <el-form-item>
                                <el-date-picker type="datetime" placeholder="选择日期" v-model="paperSet.startTime" style="width: 100%;" disabled></el-date-picker>
                            </el-form-item>
                        </el-col>
                        <el-col class="center" :span="1">-</el-col>
                        <el-col :span="10">
                            <el-form-item>
                                <el-date-picker type="datetime" placeholder="选择日期" v-model="paperSet.endTime" style="width: 100%;" disabled></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-form-item>
                    <el-form-item label="答题时长">
                        <el-input style="width:100px;" v-model.number="paperSet.duration" placeholder="分钟" disabled></el-input>
                    </el-form-item>
                    ...
                    <div class="center pt20"><el-button @click="close()">关闭</el-button></div>
                </el-form>
            </el-tab-pane>
        </el-tabs>
        ...
        findById (id) {
            ...
            .then(function (res) {
                if(res.status == 200){          
                    ...
                    // 时间
                    let time = new Date(that.paper.createTime)
                    that.paper.createTime = that.getTimer(time)
